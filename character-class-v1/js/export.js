...
const Export = {
  ...
  async buildSheetCanvas() {
    ...
    const pad = 20;
    const innerW = frameW - pad * 2 - 30; // 바인더 구멍 공간 확보
    const innerH = frameH - pad * 2;
    const innerX = frameX + pad + 30;
    ...
    const abilities = [
      { label: "강점 ①", value: Character.info.strength1 },
      { label: "강점 ②", value: Character.info.strength2 },
      { label: "약점 ①", value: Character.info.weakness1 },
      { label: "약점 ②", value: Character.info.weakness2 }
    ];
