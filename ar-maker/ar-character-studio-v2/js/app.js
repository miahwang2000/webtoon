...
const GUIDES = [
  ...
  { id: 'cat', name: '고양이', src: 'assets/guides/cat.jpg' },
  { id: 'robot', name: '로봇', src: 'assets/guides/robot.jpg' }
];
...
const App = (() => {
  ...
  function goMinigame() {
    const dataURL = ArDraw.getDataURL();
    document.getElementById('game-who-name').textContent = session.name;
    document.getElementById('game-who-class').textContent = session.className;
  ...
  function wireMinigame() {
    ...
    stage.addEventListener('pointerdown', (e) => {
      ...
      if (readyOverlay.style.display !== 'none') { beginRun(); return; }
      ArGame.jump();
    });
  }
